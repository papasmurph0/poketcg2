...
.TilemapPointers:
	dw TILEMAP_1EB ; COIN_CHANSEY
	dw TILEMAP_201 ; COIN_GR
	dw TILEMAP_1EC ; COIN_ODDISH
	dw TILEMAP_1ED ; COIN_CHARMANDER
	dw TILEMAP_1EE ; COIN_STARMIE
	dw TILEMAP_1EF ; COIN_PIKACHU
	dw TILEMAP_1F0 ; COIN_ALAKAZAM
	dw TILEMAP_1F1 ; COIN_KABUTO
	dw TILEMAP_202 ; COIN_GOLBAT
	dw TILEMAP_203 ; COIN_MAGNEMITE
	dw TILEMAP_204 ; COIN_MAGMAR
	dw TILEMAP_205 ; COIN_PSYDUCK
	dw TILEMAP_206 ; COIN_MACHAMP
	dw TILEMAP_207 ; COIN_MEW
	dw TILEMAP_208 ; COIN_SNORLAX
	dw TILEMAP_209 ; COIN_TOGEPI
	dw TILEMAP_20A ; COIN_PONYTA
	dw TILEMAP_20B ; COIN_HORSEA
	dw TILEMAP_20C ; COIN_ARBOK
	dw TILEMAP_20D ; COIN_JIGGLYPUFF
	dw TILEMAP_20E ; COIN_DUGTRIO
	dw TILEMAP_20F ; COIN_GENGAR
	dw TILEMAP_210 ; COIN_RAICHU
	dw TILEMAP_211 ; COIN_LUGIA
; COIN_GR_START
	dw TILEMAP_1F2 ; NONE
	dw TILEMAP_1F3 ; COIN_GR_PIECE1
	dw TILEMAP_1F4 ; COIN_GR_PIECE2
	dw TILEMAP_1F5 ; COIN_GR_PIECE1 | COIN_GR_PIECE2
	dw TILEMAP_1F6 ; COIN_GR_PIECE3
	dw TILEMAP_1F7 ; COIN_GR_PIECE1 | COIN_GR_PIECE3
	dw TILEMAP_1F8 ; COIN_GR_PIECE2 | COIN_GR_PIECE3
	dw TILEMAP_1F9 ; COIN_GR_PIECE1 | COIN_GR_PIECE2 | COIN_GR_PIECE3
	dw TILEMAP_1FA ; COIN_GR_PIECE4
	dw TILEMAP_1FB ; COIN_GR_PIECE1 | COIN_GR_PIECE4
	dw TILEMAP_1FC ; COIN_GR_PIECE2 | COIN_GR_PIECE4
	dw TILEMAP_1FD ; COIN_GR_PIECE1 | COIN_GR_PIECE2 | COIN_GR_PIECE4
	dw TILEMAP_1FE ; COIN_GR_PIECE3 | COIN_GR_PIECE4
	dw TILEMAP_1FF ; COIN_GR_PIECE1 | COIN_GR_PIECE3 | COIN_GR_PIECE4
	dw TILEMAP_200 ; COIN_GR_PIECE2 | COIN_GR_PIECE3 | COIN_GR_PIECE4
	dw TILEMAP_201 ; COIN_GR_PIECE1 | COIN_GR_PIECE2 | COIN_GR_PIECE3 | COIN_GR_PIECE4
